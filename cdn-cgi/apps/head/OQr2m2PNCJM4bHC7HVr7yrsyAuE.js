...
CloudflareApps.siteId = "aceac2eb4e347cdeb77095a0dcf0e574";
...
CloudflareApps.installs["iTBEMdoBks52"] = {
    appId: "t8Sk01am_9iA",
    scope: {}
};
;CloudflareApps.installs["iTBEMdoBks52"].options = {
    "advancedOptions": {
        "disableOnAJAX": false,
        "disableOnPushState": false
    },
    "color": "white",
    "hidePage": false,
    "showAdvanced": false,
...
;if (CloudflareApps.matchPage(CloudflareApps.installs['iTBEMdoBks52'].URLPatterns)) {
    (function() {
        ...
        extend = function() {
            ...
            for (_i = 0,
            _len = sources.length; _i < _len; _i++) {
                source = sources[_i];
                if (source) {
                    for (key in source) {
        ...
        Events = (function() {
            ...
            Events.prototype.trigger = function(name, val) {
                ...
                if (this.bindings[name] != null) {
                    ...
                    _results = [];
                    for (_j = 0,
                    _len1 = _ref2.length; _j < _len1; _j++) {
                        binding = _ref2[_j];
        ...
        shouldTrack = function(method) {
            ...
            if (!ignoreStack.length && options.ajax) {
                if (method === 'socket' && options.ajax.trackWebSockets) {
                    return true;
                } else if (_ref2 = method.toUpperCase(),
            ...
            if (!Pace.running && (options.restartOnRequestAfter !== false || shouldTrack(type) === 'force')) {
                ...
                return setTimeout(function() {
                    ...
                    if (stillActive) {
                        ...
                        _results = [];
                        for (_j = 0,
                        _len1 = _ref3.length; _j < _len1; _j++) {
                            source = _ref3[_j];
        ...
        (init = function() {
            ...
            for (_k = 0,
            _len2 = _ref4.length; _k < _len2; _k++) {
                source = _ref4[_k];
        ...
        Pace.go = function() {
            ...
            return animation = runAnimation(function(frameTime, enqueueNextFrame) {
                ...
                for (i = _j = 0,
                _len1 = sources.length; _j < _len1; i = ++_j) {
                    source = sources[i];
                    scalerList = scalers[i] != null ? scalers[i] : scalers[i] = [];
                    elements = (_ref2 = source.elements) != null ? _ref2 : [source];
                    for (j = _k = 0,
                    _len2 = elements.length; _k < _len2; j = ++_k) {
                        element = elements[j];
...
;(function() {
    try {
        ...
        link.rel = 'stylesheet';
        link.href = 'data:text/css;charset=utf-8;base64,';
